        ...
        if (isset($_POST['submitted'])) {
            ...
            if (empty($_POST['username'])) {
                ...
                try {
                    ...
                    $stat = $conn->prepare("UPDATE cvs SET username='$username', email='$email', keyprogramming='$keyprogramming', 
                profile='$profile', education='$education', url='$url' where username='$id'");
